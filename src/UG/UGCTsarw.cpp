...
OnDraw - overloaded CUGCellType::OnDraw
    ...
    **See CUGCellType::OnDraw for more details
	about this function
****************************************************/
void CUGSortArrowType::OnDraw(CXeD2DRenderContext* pRctx, EXE_FONT eFont, RECT *rect,int col,long row,
...
//		}
//		else if(cellTypeEx&UGCT_SORTARROWDOWN){
...
//
//	if( cellTypeEx & (UGCT_SORTARROWUP | UGCT_SORTARROWDOWN) )
...
Return:
	<none>
*****************************************************/
void CUGSortArrowType::GetBestSize(CSize *size,CUGCell *cell)
{
