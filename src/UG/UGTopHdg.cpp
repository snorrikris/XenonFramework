...
***************************************************/
CUGTopHdg::CUGTopHdg(CXeUIcolorsIF* pUIcolors) : CXeD2DWndBase(pUIcolors)
{
	//init the varialbes
	m_isSizing	= FALSE;
	m_canSize	= FALSE;
...
bool CUGTopHdg::CreateTopHdg(DWORD dwStyle, const CRect& rect, HWND hParentWnd, UINT nID)
{
...
void CUGTopHdg::_PaintF(ID2D1RenderTarget* pRT, D2D1_RECT_F rcClient)
{
...
Returns:
	<none>
*****************************************************/
void CUGTopHdg::DrawCellsIntern(CXeD2DRenderContext* pRctx)
{
...
LRESULT CUGTopHdg::_OnMouseMove(UINT nFlags, CPoint point)
{
...
LRESULT CUGTopHdg::_OnLeftDown(UINT nFlags, CPoint point)
{
	int col;
	int row;
	RECT rect;
...
LRESULT CUGTopHdg::_OnLeftUp(UINT nFlags, CPoint point)
{
	int col;
	int row;
	RECT rect;
...
LRESULT CUGTopHdg::_OnLeftDoubleClick(UINT nFlags, CPoint point)
{
	int		col,
			row;
	RECT	rect;
...
LRESULT CUGTopHdg::_OnRightDown(UINT nFlags, CPoint point)
{
	int col;
	int row;
	RECT rect;
...
LRESULT CUGTopHdg::_OnRightUp(UINT nFlags, CPoint point)
{
	int col;
	int row;
	RECT rect;
...
LRESULT CUGTopHdg::_OnSetCursor(WPARAM wParam, LPARAM lParam)
{
...
*****************************************************/
//INT_PTR CUGTopHdg::OnToolHitTest(  CPoint point, TOOLINFO *pTI ) const
//{
//	int col;
//	long row;
//	CRect rect;
