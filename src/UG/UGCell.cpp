...
*********************************************/
int	CUGCell::GetText(std::wstring *text)
{
...
*********************************************/
void CUGCell::SetFoundTextOffset(int nCharIndexOfFoundText, int nLengthOfFoundText)
{
	m_nCharIndexOfFoundText = nCharIndexOfFoundText;
	m_nLengthOfFoundText = nLengthOfFoundText;
}
int CUGCell::GetFoundTextOffset(int & nLengthOfFoundText)
{
...
GetMask
	...
	Return 
		...
		UG_ERROR	fail
*********************************************/
int	CUGCell::GetMask(std::wstring *text){
...
GetLabelText
	...
	Return 
		...
		UG_ERROR	fail
*********************************************/
int	CUGCell::GetLabelText(std::wstring *text){
...
SetFont
	...
	Return
		...
		UG_ERROR	fail
*********************************************/
int	CUGCell::SetFont(EXE_FONT font)
{
...
int CUGCell::SetPngImg(PID pngImgId)
{
	if (pngImgId > (PID)0) {
...
StringToNumber
	...
	Return
		...
		UG_ERROR	fail
*********************************************/
int CUGCell::StringToNumber(std::wstring *string,double *number)
{
