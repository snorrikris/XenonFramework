...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::GetColName(int col,std::wstring * string)
{
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::FindFirst(std::wstring *string,int *col,long *row,long flags)
{
	UNREFERENCED_PARAMETER(*string);
	UNREFERENCED_PARAMETER(*col);
	UNREFERENCED_PARAMETER(*row);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::FindNext(std::wstring *string,int *col,long *row,int flags)
{
	UNREFERENCED_PARAMETER(*string);
	UNREFERENCED_PARAMETER(*col);
	UNREFERENCED_PARAMETER(*row);
...
****************************************************/
int CUGDataSource::OnEditStart(int col, long row,HWND edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
****************************************************/
int CUGDataSource::OnEditVerify(int col,long row,HWND edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
****************************************************/
int CUGDataSource::OnEditFinish(int col, long row,HWND edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
