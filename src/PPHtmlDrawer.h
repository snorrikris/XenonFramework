...
// Construction
public:
	CPPHtmlDrawer(CXeUIcolorsIF* pUIcolors);
...
public:
	...
	//void SetCallbackRepaint(CXeUIcolorsIF* pUIcolors, HWND hWnd, UINT nMessage, LPARAM lParam = 0); //Sets the callback message: "Please repaint me".
...
#pragma pack()
	...
	//std::unique_ptr<CPPDrawManager> m_drawmanager;
...
//	mapTags m_mapTableProp;
	...
	// +++hd
	int m_nIDTool;
	// allows programmer to set desired font - jms 07/14/2006
protected:
	//LOGFONT m_lfCustom;
	//BOOL m_bUseCustomFont;
public:
	//void SetUseCustomFont(BOOL bVal)    { m_bUseCustomFont = bVal; };
	//void SetCustomFont   (LOGFONT fVal) { m_lfCustom       = fVal; };
	//LOGFONT GetCustomFont()             { return m_lfCustom;       };
	// end jms
...
//public:
	...
	//void JumpToHyperlink(int nLink, int nIDTool);
