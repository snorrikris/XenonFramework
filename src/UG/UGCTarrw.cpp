...
Return
	<none>
****************************************************/
void CUGArrowType::OnDraw(CXeD2DRenderContext* pRctx, EXE_FONT eFont, RECT *rect,int col,long row,CUGCell *cell,int selected,int current)
{
...
Return:
	<none>
*****************************************************/
void CUGArrowType::GetBestSize(CSize *size,CUGCell *cell)
{
