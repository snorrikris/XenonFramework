...
CPPHtmlDrawer::CPPHtmlDrawer(CXeUIcolorsIF* pUIcolors) : m_xeUI(pUIcolors)
{
	//m_drawmanager = std::make_unique<CPPDrawManager>(pUIcolors);
...
//
//	CPPTOOLTIP_TRACE("lf.lfFaceName=%s =========\n"), lf.lfFaceName);
//
//    return &lf; 
...
//	CPPTOOLTIP_TRACE("Jump to Hyperlink number = %d\n"), nLink);
...
//{
//	CPPTOOLTIP_TRACE("CPPHtmlDrawer::CallbackOnRepaint()\n")); 
//
...
//{
//	CPPTOOLTIP_TRACE("CPPHtmlDrawer::CallbackOnClickHyperlink()\n")); 
//
...
/////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawHtml (TT_Render& rndr, LPSIZE lpSize, LPCRECT lpRect)
{
...
SIZE CPPHtmlDrawer::DrawHtmlTable (TT_Render& rndr, CPPString & sTable, LPCRECT lpRect)
{
...
//
///////////////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawHtmlTableRow(TT_Render& rndr, CPPString & sRow, LPCRECT lpRect, STRUCT_TABLE & st, int nRow)
{
...
//
///////////////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawHtmlTableCell(TT_Render& rndr, CPPString & sCell, LPCRECT lpRect, STRUCT_CELL & sc)
{
	if (MODE_DRAW != m_nNumPass)
	{
		sc.szText.cx = 0;
...
SIZE CPPHtmlDrawer::DrawHtmlString (TT_Render& rndr, CPPString & sHtml, LPCRECT lpRect)
{
	SIZE szTextArea = {0, 0};
...
void CPPHtmlDrawer::PrepareOutput(LPCTSTR lpszHtml, LPSIZE lpSize)
{
	//ASSERT(FALSE); // FIXME if needed
...
//						  drawing area.
////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawPreparedOutput(TT_Render& rndr, LPCRECT lpRect)
{
	//ASSERT(FALSE); // FIXME if needed
...
//
//		CPPTOOLTIP_TRACE("loading from IDC_HAND\n"));
...
//
//			CPPTOOLTIP_TRACE("loading from winhlp32\n"));
//
...
//{
//	CPPTOOLTIP_TRACE("CPPHtmlDrawer::SetCallbackHyperlink()\n"));
//
...
//void CPPHtmlDrawer::SetCallbackRepaint(CXeUIcolorsIF* pUIcolors, HWND hWnd, UINT nMessage, LPARAM lParam /* = 0 */)
//{
//	CPPTOOLTIP_TRACE("CPPHtmlDrawer::SetCallbackRepaint()\n"));
//
//	m_xeUI = pUIcolors;
//
...
//	m_nDarkenShadow = (BYTE)std::min((BYTE)100, nDarkenPercent);
